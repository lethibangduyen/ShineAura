    ...
    return (
        <div>
            ...
            <div className="flex-col content-container">
                ...
                <div className="sectionContainer flex-col ivory-bg ourStoryContainer">
                    <div className="section flex-col">
                        <div className="ourStory">  
                            <div className="right-container">
                                <ImageSlider images={sliderImages}/>
                            </div>
                            <div className="left-container md-spc">
                                <p class="pre-title">About  us</p>
                                <h2 className="h2">Our Story</h2>
                                <p className="body">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis vel tellus lectus. Sed sagittis, risus vitae dignissim semper, turpis arcu congue augue, eget ornare orci libero nec enim. Aenean a aliquam nunc. Morbi tincidunt mattis nulla et interdum. Donec mollis tincidunt pellentesque. Vivamus laoreet sodales accumsan. Integer ornare vulputate mi posuere elementum.</p>
                            </div>
                        </div>
                    </div>
                </div>
