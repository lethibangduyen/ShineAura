...
const ProductCard = ({ product, addToCart, updateCartItemCount }) => {
    ...
    const addToCartHandler = () => {
        addToCart(product, 1); // Truyền số lượng là 1 khi thêm vào giỏ hàng
        updateCartItemCount(); // Cập nhật cart item count
    };
    ...
    return (
        <div className={containerClassName}>
            <div className='flex-col prod-holder'>
                ...
                <span className="cart-plus-icon" onClick={addToCartHandler}>
            ...
            <div className='flex-col align-left prod-info-exp'>
                <div className='prod-info-exp-holder flex-col gap-xs align-left'>
                    ...
                    <div className='flex-row gap-xs btn-collection'>
                        ...
                        <button className='body-lgt uppercase' onClick={addToCartHandler}>
                            add to cart
                        </button>
                    </div>
